                        ...
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item">
                                <button data-category-id=""
                                    class="category-tab d-flex m-2 py-2 bg-light rounded-pill active">
                            ...
                            @foreach ($categories as $category)
                                <li class="nav-item">
                                    <button data-category-id="{{ $category->id }}"
                                        class="category-tab d-flex py-2 m-2 bg-light rounded-pill">
...
@section('web-script')
    <script>
        ...
        /**
         * hàm tải danh sách sản phẩm theo danh mục
         */
        function searchProductMenu(page = 1, categoryId = null) {
            $.ajax({
                url: '<?= route('website.home.searchProductByCategory') ?>?page=' + page,
                type: "POST",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
